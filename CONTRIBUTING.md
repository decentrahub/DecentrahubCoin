Contributing to Decentrahub Coin
============================

The Decentrahub Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/decentrahub-project/decentrahub/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Decentrahub Coin project, and is not to be
confused with overall Decentrahub Network Protocol consensus changes.

Whether a pull request is merged into Decentrahub Coin rests with the project merge
...
Patches that change Decentrahub consensus rules are considerably more involved than
...
Where a patchset proposes to change the Decentrahub consensus, it must have been
...
The project leader is the release manager for each Decentrahub Coin release.
