...
The script [extract-osx-sdk.sh](https://github.com/decentrahub-project/decentrahub/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
decentrahub/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/decentrahub-project/decentrahub/blob/master/doc/README_osx.md) for troubleshooting tips.
