...
The build script we'll be using is contained in the Decentrahub github repository ([contrib/gitian-build.py](https://github.com/decentrahub-project/decentrahub/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Decentrahub repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Decentrahub-Project/Decentrahub/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, decentrahub-detached-sigs, and decentrahub GitHub repos.
