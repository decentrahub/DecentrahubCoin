...
This document provides guidelines for internationalization of the Decentrahub Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Decentrahub network</source>
        <translation>
            <numerusform>%n active connection to Decentrahub network</numerusform>
            <numerusform>%n active connections to Decentrahub network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `decentrahub_en.ts` remains unchanged.
