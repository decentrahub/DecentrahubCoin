...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Decentrahub Coin decentrahub-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  decentrahub-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded decentrahub transaction") + "\n" +
                               "  decentrahub-tx [options] -create [commands]   " + _("Create hex-encoded decentrahub transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded decentrahub transaction
