...
//
// The Masternode Class. It contains the input of the Current Collateral, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is current collateral - checking if valid masternode)
