...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            DecentrahubGUI* window = static_cast<DecentrahubGUI*>(parentWidget());
...
{
    DecentrahubGUI* gui = static_cast<DecentrahubGUI*>(parentWidget());
...
{
    hide();
    static_cast<DecentrahubGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Decentrahub will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your DCNTRs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
