...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(DCNTR);
    unitlist.append(mDCNTR);
    unitlist.append(uDCNTR);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case DCNTR:
        return QString("decentrahub");
    case mDCNTR:
        return QString("mdecentrahub");
    case uDCNTR:
        return QString::fromUtf8("udecentrahub");
    default:
        return QString("???");
    }
}
