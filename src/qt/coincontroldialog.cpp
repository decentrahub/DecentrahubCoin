...
void CoinControlDialog::updateLabels()
{
    ...
    int nDisplayUnit = BitcoinUnits::DCNTR;
    ...
    for (PAIRTYPE(QString, std::vector<COutput>) coins : mapCoins) {
        ...
        for(const COutput& out: coins.second) {
            ...
            if (haveDest) {
                ...
                // if listMode or change => show Decentrahub address. In tree mode, address is not shown again for direct wallet address outputs
