...
#include "qt/decentrahub/forms/ui_addresseswidget.h"
#include "qt/decentrahub/addresslabelrow.h"
#include "qt/decentrahub/addnewaddressdialog.h"
#include "qt/decentrahub/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(DecentrahubGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination dcntrAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(dcntrAdd, label.toUtf8().constData(),
