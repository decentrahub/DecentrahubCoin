...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, DecentrahubGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, DecentrahubGUI* gui, double posX = 3);
