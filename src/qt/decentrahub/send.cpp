...
#include "qt/decentrahub/forms/ui_send.h"
#include "qt/decentrahub/addnewcontactdialog.h"
#include "qt/decentrahub/qtutils.h"
#include "qt/decentrahub/sendchangeaddressdialog.h"
#include "qt/decentrahub/optionbutton.h"
#include "qt/decentrahub/sendconfirmdialog.h"
#include "qt/decentrahub/myaddressrow.h"
#include "qt/decentrahub/guitransactionsutils.h"
...
SendWidget::SendWidget(DecentrahubGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-dcntr");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination dcntrAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(dcntrAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(dcntrAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
