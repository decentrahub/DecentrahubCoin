...
#include "qt/decentrahub/sendcustomfeedialog.h"
#include "qt/decentrahub/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(DecentrahubGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &DecentrahubGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
