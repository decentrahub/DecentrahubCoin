...
#include "qt/decentrahub/settings/settingsbackupwallet.h"
#include "qt/decentrahub/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/decentrahub/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(DecentrahubGUI* _window, QWidget *parent) :
