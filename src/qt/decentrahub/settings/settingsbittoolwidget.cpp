...
#include "qt/decentrahub/settings/settingsbittoolwidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(DecentrahubGUI* _window, QWidget *parent) :
