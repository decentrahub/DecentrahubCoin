...
#include "qt/decentrahub/settings/settingsconsolewidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/decentrahub/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(DecentrahubGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Decentrahub Coin RPC console.") + "<br>" +
