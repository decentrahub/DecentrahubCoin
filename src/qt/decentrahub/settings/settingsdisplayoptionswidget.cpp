...
#include "qt/decentrahub/settings/settingsdisplayoptionswidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(DecentrahubGUI* _window, QWidget *parent) :
