...
#include "qt/decentrahub/settings/settingsexportcsv.h"
#include "qt/decentrahub/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(DecentrahubGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Decentrahub_tx_csv_export(*.csv)") : tr("Decentrahub_addresses_csv_export(*.csv)"),
                                        nullptr);
