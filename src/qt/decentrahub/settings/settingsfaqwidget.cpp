...
#include "qt/decentrahub/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/decentrahub/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(DecentrahubGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableDCNTR,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableDCNTR,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableDCNTR,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableDCNTR,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableDCNTR, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableDCNTR);});
    ...
    if (parent)
        connect(parent, &DecentrahubGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
