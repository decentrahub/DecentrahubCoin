...
#include "qt/decentrahub/settings/settingsmainoptionswidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(DecentrahubGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start Decentrahub Coin on system login"));
