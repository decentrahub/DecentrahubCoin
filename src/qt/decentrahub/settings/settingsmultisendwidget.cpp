...
#include "qt/decentrahub/settings/settingsmultisendwidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/decentrahub/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other Decentrahub Coin addresses after it matures."));
