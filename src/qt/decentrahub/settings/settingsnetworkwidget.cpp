...
#include "qt/decentrahub/settings/settingsnetworkwidget.h"
#include "qt/decentrahub/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/decentrahub/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DecentrahubGUI* _window, QWidget *parent) :
