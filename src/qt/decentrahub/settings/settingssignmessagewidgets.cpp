...
#include "qt/decentrahub/settings/settingssignmessagewidgets.h"
#include "qt/decentrahub/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(DecentrahubGUI* _window, QWidget *parent) :
