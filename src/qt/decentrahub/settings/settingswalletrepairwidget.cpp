...
#include "qt/decentrahub/settings/settingswalletrepairwidget.h"
#include "qt/decentrahub/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/decentrahub/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(DecentrahubGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DecentrahubGUI::handleRestart()
