...
#include "qt/decentrahub/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(DecentrahubGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &DecentrahubGUI::openFAQ);
