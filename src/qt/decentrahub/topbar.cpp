...
#include "qt/decentrahub/topbar.h"
#include "qt/decentrahub/forms/ui_topbar.h"
#include "qt/decentrahub/lockunlock.h"
#include "qt/decentrahub/qtutils.h"
#include "qt/decentrahub/receivedialog.h"
#include "qt/decentrahub/loadingdialog.h"
...
TopBar::TopBar(DecentrahubGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopDcntr}, "amount-small-topbar");
    setCssProperty({ui->labelAmountDcntr}, "amount-topbar");
    setCssProperty({ui->labelPendingDcntr, ui->labelImmatureDcntr}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Decentrahub")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // DCNTR Total
    QString totalDcntr = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // DCNTR
    // Top
    ui->labelAmountTopDcntr->setText(totalDcntr);
    // Expanded
    ui->labelAmountDcntr->setText(totalDcntr);
    ui->labelPendingDcntr->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureDcntr->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
