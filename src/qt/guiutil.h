...
/** Utility functions used by the Decentrahub Qt UI.
 */
namespace GUIUtil
{
...
// Render Decentrahub addresses in monospace font
...
// Parse "decentrahub:" URI into recipient object, return true on successful parsing
