...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Decentrahub Coin"),
     ...
     * override -datadir in the decentrahub.conf file in the default data directory
     * (to be consistent with decentrahubd behavior)
     */
