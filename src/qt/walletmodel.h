...
#ifndef Decentrahub_QT_WALLETMODEL_H
#define Decentrahub_QT_WALLETMODEL_H
...
/** Interface to Decentrahub wallet from Qt view code. */
...
#endif // Decentrahub_QT_WALLETMODEL_H
